...
We train SiLVR networks for each of these dependent variables. While the MAPE is quite good (less than 2% in all cases), lets take a look at some of the inferences we can draw from these learnt networks. For details of the experiment you can look at our <a href="http://dl.acm.org/citation.cfm?id=1278542&CFID=780583300&CFTOKEN=56675120">paper</a>.
