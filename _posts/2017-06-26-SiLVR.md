...
![2-D input space with 1 latent variable that explains all the variation in the dependent variable.]({{site.baseurl}}/images/2var1lv.tif "2-D input space with 1 latent variable that explains all the variation in the dependent variable.")
